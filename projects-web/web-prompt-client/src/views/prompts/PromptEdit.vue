    ...
    <div class="main-content">
      <div class="header">
        <div class="header-left">
          ...
          <h1 class="page-title">编辑 Prompt</h1>
        </div>
          ...
          <el-form :model="form" :rules="rules" ref="formRef" label-width="100px">
            ...
            <el-form-item label="版本信息">
              <div class="version-info">
                <p>当前版本: v{{ form.version }}</p>
                <p>创建时间: {{ form.createdAt }}</p>
                <p>最后更新: {{ form.updatedAt }}</p>
              </div>
            </el-form-item>
          </el-form>
        </div>
...
onMounted(() => {
  ...
  console.log('编辑 Prompt ID:', promptId)
...
请提供详细的审查报告和改进建议。`,
  ...
  Object.assign(form, mockPrompt)
  extractVariables(mockPrompt.content)
})
</script>
